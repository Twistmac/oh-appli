...
export default class Footers extends Component {
  ...
  annonces(){
    ...
    // })
    this.props.navigation.navigation.navigate(AnnoncesScreen)
  }
  ...
  keys(){
    ...
    //   activeButtonAnnonces:false,
    //   activeButtonMessages : false,
    //   activeButtonkeys : true,
    // })
    this.props.navigation.navigation.navigate(AccessScreen)
  }
  render() {
    return (
        ...
        <Footer style = {{backgroundColor:'transparent'}} >
          <FooterTab  style={styles.FooterTabColor}>
            ...
            <Button
              onPress ={this.keys.bind(this)}>
              <View style ={[styles.rondYellow,{backgroundColor:this.state.couleurAcces}]} >
