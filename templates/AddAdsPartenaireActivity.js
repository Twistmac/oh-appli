...
import {LoginScreen, HomePartenaireScreen} from '../route/ScreenName';
...
export default class AddAdsPartenaire extends Component {
	constructor(props) {
	  super(props);
	...
	postNotImage(){
		//console.warn(global.detailPartenaire[0].categorie_id);
		...
		const params = {
			...
			categorie : global.detailPartenaire[0].categorie_id,
			description : this.state.description,
			syndic_id : global.detailPartenaire[0].residence_id
		}
		postAnnonceRes(params).then((data)=>{
			...
			this.props.navigation.navigate(HomePartenaireScreen);
			Toast.show({
								text: "Add success !",
								buttonText: "Ok",
								duration:3000,
			...
			<Container>
				...
				<View style ={styles.container} >
					<Form>
			            	...
			            	<Text style={{fontSize:16, color:'black'}} > Category :
												<Text style={{fontSize:19,fontWeight: 'bold'}} > {global.detailPartenaire[0].name} </Text>
