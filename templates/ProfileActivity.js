...
import {register, getProfile} from './services/Services';
import style from '../Styles/Style';
import {HomeScreen} from '../route/ScreenName';
...
export default class ProfileActivity extends Component {
	...
	componentDidMount(){
		...
		getProfile(global.id).then((data) =>{
			// console.warn(data);
			this.setState({
			...
			// this.setDate.bind(this, this.state.chosenDate);
		})
	}
	setDate(newDate) {
