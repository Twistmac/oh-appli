...
// create a component
class ChatPartenaireItem extends Component {
    ...
    showAvatarOrNoT(message) {
                if (message.senderId != global.detailPartenaire[0].id_partenaire) {
                    return (
                        <Thumbnail
    ...
    _renderTouchableInMymessage(message){
        const isMyMessage = message.senderId == global.detailPartenaire[0].id_partenaire;
...
export default connect(mapStateToProps)(ChatPartenaireItem); 
