...
import {getAnnonces, getAnnoncesSyndic,AnnoncePartenaire, AnnoncePartenaireSyndic,getResidenceById} from './services/Services';
...
export default class AnnonceResidence extends Component {
  constructor(props) {
    super(props);
  ...
  static navigationOptions = {
    ...
    componentDidMount(){
      getResidenceById(global.detailPartenaire[0].residence_id).then((data)=>{
        //console.warn(data);
          this.setState({
            titre: data[0].nom
          })
      ...
      AnnoncePartenaireSyndic(global.detailPartenaire[0].categorie_id, global.detailPartenaire[0].residence_id).then((data)=>{
        this.setState({ 
